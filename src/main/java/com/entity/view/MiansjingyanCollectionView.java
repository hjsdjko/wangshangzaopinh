...
public class MiansjingyanCollectionView extends MiansjingyanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String miansjingyanCollectionValue;
		...
		//级联表 miansjingyan
			...
			* 面试经验 的 用户
			*/
			private Integer miansjingyanYonghuId;
			/**
			* 面试经验标题
			*/
	...
	public MiansjingyanCollectionView() {

	}

	public MiansjingyanCollectionView(MiansjingyanCollectionEntity miansjingyanCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, miansjingyanCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getMiansjingyanCollectionValue() {
				return miansjingyanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setMiansjingyanCollectionValue(String miansjingyanCollectionValue) {
				this.miansjingyanCollectionValue = miansjingyanCollectionValue;
			}
				...
				//级联表的get和set miansjingyan

					/**
					* 获取：面试经验 的 用户
					*/
					public Integer getMiansjingyanYonghuId() {
						return miansjingyanYonghuId;
					}
					/**
					* 设置：面试经验 的 用户
					*/
					public void setMiansjingyanYonghuId(Integer miansjingyanYonghuId) {
						this.miansjingyanYonghuId = miansjingyanYonghuId;
					}
